  ...
  return (
    <section className="container-fluid my-3" id="about">
      <div className="row my-1">
        <div className="col-sm-12 fs-1 fw-bolder text-center">Hi</div>
      </div>

      <div className="row my-1">
        <div className="col-sm-12 fs-3 fw-semibold text-center">
          I'm Laila, a Frontend developer
        </div>
      </div>
      ...
      <div className="row my-4">
        <div className="col-sm-12 fs-3 fw-semibold text-center">
          <img
            src={process.env.PUBLIC_URL + "/Laila.jpg"}
            alt="Laila"
      ...
      <div className="row my-1">
        <div className="col-sm-12 fs-5 fw-normal text-center">
          {props.overview} I got my {bsc.degree} degree from {bsc.institution}{" "}
          in {bsc.major} in the year 2021.
        </div>
      </div>
    </section>
  );
